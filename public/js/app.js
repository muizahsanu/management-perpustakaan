...
$(document).ready(function () {
  ...
  if (datas.length > 0) {
    selector.each(function (index, item) {
      ...
      var inputSearch = selectorId + ' input[type=search]';
      var inputHidden = selectorId + ' input[type=hidden]';
      var selectorOption = selectorId + ' option';
      var selectorContent = selectorId + ' .selector__content';
      datas[i].forEach(function (element) {
        $(selectorContent).append("<option class=\"selector__item\" value=\"".concat(element.id, "\">").concat(element.name, "</option>"));
      });
      updateSelectorItem(inputSearch, datas[i], selectorContent, selectorOption, inputHidden); // $(inputSearch).keyup((e)=>{
      //     console.log(datas[i]);
      //     updateSelectorItem(e.target.value, datas[i])
      // })

      $(selectorOption).click(function (e) {
...
function updateSelectorItem(inputSearch, oldData, selectorContent, selectorOption, inputHidden) {
  $(inputSearch).keyup(function (e) {
    var newData = oldData.filter(function (data) {
